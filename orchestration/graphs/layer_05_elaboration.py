"""Subgraph for layer 05-elaboration.

Importable entrypoint:
    from orchestration.graphs.layer_05_elaboration import graph
    result = graph.invoke({"layer_id": "05-elaboration", ...})
...
graph = build_subgraph("05-elaboration")
