"""Subgraph for layer 00-bootstrap.

Importable entrypoint:
    from orchestration.graphs.layer_00_bootstrap import graph
    result = graph.invoke({"layer_id": "00-bootstrap", ...})
...
graph = build_subgraph("00-bootstrap")
