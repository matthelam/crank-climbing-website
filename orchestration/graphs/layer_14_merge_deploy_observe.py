"""Subgraph for layer 14-merge-deploy-observe.

Importable entrypoint:
    from orchestration.graphs.layer_14_merge_deploy_observe import graph
    result = graph.invoke({"layer_id": "14-merge-deploy-observe", ...})
...
graph = build_subgraph("14-merge-deploy-observe")
